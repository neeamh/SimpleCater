...
export default function HomePage() {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Head>
        <title>CommonCater - Catering Services Made Accessible</title>
        <meta
          name="description"
          content="Experience gourmet meals delivered right to your event with CommonCater."
        />
        ...
        <Toolbar sx={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <Button
            ...
            sx={{
              ...
              color: scrolledPastHero ? '#FFF' : 'var(--primary)',
              textTransform: 'none',
              '&:hover': {
